...
public class ListenersLogic implements ITestListener{
	...
	public void onTestSuccess(ITestResult result) {
		...
		String path = "C:\\Users\\admin\\eclipse-workspace1\\project1\\src\\test\\java\\screenshots\\pass\\TestCasePass";
		screenshot(path);
	...
	public void onTestFailure(ITestResult result) {
		...
		String path = "C:\\Users\\admin\\eclipse-workspace1\\project1\\src\\test\\java\\screenshots\\fail\\TestCaseFail";
		screenshot(path);
		Reporter.log("Screenshot is completed");
	}
